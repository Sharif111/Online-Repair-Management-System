...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">ORMS</a>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">ORMS Services</h3>
      <p>
        ORMS Services is Bangladesi’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Rahul Hasan</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Arif Mahmud</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        ORMS Pvt Ltd, <br>
        Gulshan 1, Dhaka-1213 <br>
        Phone: +8801921104105 <br>
        <a href="#" target="_blank">www.orms.com</a> <br>

        <br><br>
        <strong>Rampura Branch:</strong> <br>
        ORMS Pvt Ltd, <br>
        Banasree, Dhaka-1219 <br>
        Phone: +8801921104106 <br>
        <a href="#" target="_blank">www.orms.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by sijan &copy; 2020.
          </small>
